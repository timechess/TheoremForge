...
class Config:
    ...
    @property
    def self_correction_agent(self):
        """Get Self Correction Agent configuration"""
        return self._config.get("SelfCorrectionAgentConfig", {})

    @property
    def theorem_retrieval_agent(self):
        """Get Theorem Retrieval Agent configuration"""
        return self._config.get("TheoremRetrievalAgentConfig", {})
